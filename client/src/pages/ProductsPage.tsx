...
const ProductPage = () => {
  ...
  const { id } = useParams(); // Route should be /products/:id
            ...
            leading-relaxed mb-6"
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <span
                    className="px-5 text-sm font-semibold min-w-[40px] 
                  text-center"
                  >
                    {displayQuantity}
                  </span>
                ...
                onClick={()=>{
                  ...
                  active:scale-[0.98] ${inCart ? "bg-app-cream text-app-green border border-app-green" : "bg-app-orange text-white hover:bg-app-orange-dark"}`}
                >
        ...
        {relatedProducts.length > 0 && (
          <section className="mt-12 mb-44">
            <div className="flex items-center justify-between mb-6">
              ...
              transition-colors" to={`/products?category=${product.category}`}>
