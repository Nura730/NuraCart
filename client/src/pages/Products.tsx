        ...
        <div className="flex gap-8 xl:gap-10">
          ...
          <aside className="hidden lg:block w-64 shrink-0">
            <div className="bg-white rounded-2xl p-4 sticky top-24">
              <FilterPanel categories={categoriesData} category={category} organic={organic} minPrice={minPrice} maxPrice={maxPrice} updateFilter={updateFilter} clearFilter={clearFilter} hasFilters={hasFilters}/>
            </div>
            </aside>
          {/*Main Content*/}
            ...
            {/*Header*/}
             <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <div className="relative">
                  <select value={sort} onChange={(e)=>updateFilter("sort",e.target.value)} className="appearance-none pl-3 pr-8 py-2 text-sm bg-white rounded-xl border border-app-border focus:border-app-green outline-nonw cursor-pointer">
                  ...
                  h-3.5 text-app-text-light pointer-events-none" />
                </div>
              </div>
             </div>
             ...
             {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <button onClick={clearFilter} className="px-5 py-2 text-sm
                font-medium bg-app-green text-white rounded-xl
        ...
        <div className="fixed inset-0 bg-black/40 z-50" onClick={()=>setMobileFiltersOpen(false)} />
          <div className="fixed bottom-0 left-0 right-0 bg-white z-50 rounded-t-2xl max-h-[80vh] overflow-y-auto animate-slide-in-up">
            ...
            <div className="p-4">
              ...
              organic={organic} minPrice={minPrice} 
              maxPrice={maxPrice}
